                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="/updatekaryawan" enctype="multipart/form-data">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                          <img
                            src="{{ asset('img/profiles/' . $datas[0]->foto) }}"
                            alt="user-avatar"
                        ...
                        <input name="passwordOld"value="{{$datas[0]->password}}" hidden>
                        <input name="fotoOld" value="{{$datas[0]->foto}}" hidden>
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{$datas[0]->email}}" placeholder="Masukkan email"/>
                          </div>
                          <div class="mb-3 col-md-6">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <textarea class="form-control" id="address" name="alamat" placeholder="Isi keterangan kehadiran">{{$datas[0]->alamat}}</textarea>
                          </div>
                        </div>
                        <div class="mt-2">
